...
RSpec.describe Checks::RuntimeResolver, type: :service do
  ...
  describe "#call" do
    ...
    it "returns a Runtime data object with ruby, rubygems, and bundler versions" do
      runtime = described_class.new(target_release, lockfile_ruby: nil, lockfile_bundler: nil).call
    ...
    it "takes the max of the lockfile version and the release minimum" do
      runtime = described_class.new(target_release, lockfile_ruby: "3.3.1", lockfile_bundler: "2.5.0").call
    ...
    it "falls back to the Gems API minimums when the release has none" do
      target_release.update_columns(minimum_ruby_version: nil, minimum_bundler_version: nil)

      runtime = described_class.new(target_release, lockfile_ruby: nil, lockfile_bundler: "2.4.10").call
